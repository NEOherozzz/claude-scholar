...
# Example: ./backup-skill.sh ~/.opencode/skills/git-workflow
...
if [ $# -eq 0 ]; then
    ...
    echo "Example: $0 ~/.opencode/skills/git-workflow"
    exit 1
fi
...
BACKUP_DIR="${OPENCODE_DIR:-$HOME/.opencode}/skills/backup/${SKILL_NAME}-${TIMESTAMP}"
