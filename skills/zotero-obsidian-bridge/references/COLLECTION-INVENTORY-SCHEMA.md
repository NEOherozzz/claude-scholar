...
|---|---|---|---|
| ABCDEFGH | Example title | Sources/Papers/Wang-2026-Example-Paper.md | covered |
...
- `Canonical Note` should normally follow `Sources/Papers/{FirstAuthor}-{Year}-{ShortTitle}.md`.
